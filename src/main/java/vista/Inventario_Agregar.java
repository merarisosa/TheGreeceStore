...
public class Inventario_Agregar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        title.setText("Inventarios - Agregar artículos");
...
//            java.util.logging.Logger.getLogger(Inventario_Agregar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
